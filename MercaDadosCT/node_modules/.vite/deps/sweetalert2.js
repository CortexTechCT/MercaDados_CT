...
`;
		...
		*/
		const removeKeydownHandler = (globalState$1) => {
			if (globalState$1.keydownTarget && globalState$1.keydownHandlerAdded) {
				globalState$1.keydownTarget.removeEventListener("keydown", globalState$1.keydownHandler, { capture: globalState$1.keydownListenerCapture });
		...
		*/
		const addKeydownHandler = (globalState$1, innerParams, dismissWith) => {
			...
			if (!innerParams.toast) {
				globalState$1.keydownHandler = (e) => keydownHandler(innerParams, e, dismissWith);
				globalState$1.keydownTarget = innerParams.keydownListenerCapture ? window : getPopup();
				globalState$1.keydownListenerCapture = innerParams.keydownListenerCapture;
				globalState$1.keydownTarget.addEventListener("keydown", globalState$1.keydownHandler, { capture: globalState$1.keydownListenerCapture });
		...
		*/
		const handlePopupAnimation = (instance, popup, innerParams) => {
			...
			else removePopupAndResetState(instance, container, innerParams.returnFocus, innerParams.didClose);
		};
		/**
		* @param {SweetAlert} instance
		* @param {HTMLElement} popup
		...
		const setupTimer = (globalState$1, innerParams, dismissWith) => {
			...
			if (innerParams.timer) {
				...
				if (innerParams.timerProgressBar) {
					...
					setTimeout(() => {
						if (globalState$1.timeout && globalState$1.timeout.running) animateTimerProgressBar(innerParams.timer);
					});
				}
			}
		};
